...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return jo}setAriaExpanded(r,n){r.setAttribute("aria-expanded",n)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};p(nt,"variantStyle",P`
...
`;var yr=class extends C{constructor(t){super(t)}getGlobalCSS(){return Yo}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var Tr=class extends C{constructor(t){super(t)}getGlobalCSS(){return Xo}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var xc=32,it=class extends C{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){vr()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};p(it,"variantStyle",P`
...
`;var ot=class extends C{constructor(t){super(t)}getGlobalCSS(){return qo}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
...
`;var Ve=class extends C{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Zo}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return x` ${this.badge}
...
`;var at=class extends C{constructor(t){super(t)}getGlobalCSS(){return Jo}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
        ${this.promoBottom?"":x`<slot name="promo-text"></slot><slot name="callout-content"></slot>`}
...
`;var Xn={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},st=class extends C{constructor(t){super(t)}getGlobalCSS(){return Qo}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return Xn}renderLayout(){return x`${this.cardImage}
            <div class="body">
...
`;var ct=class extends C{constructor(t){super(t)}getGlobalCSS(){return ea}renderLayout(){return x`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
...
`;var qn={badge:{color:"rgb(0, 101, 62)",backgroundColor:"transparent"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"footer"},ctas:{slot:"footer",size:"M"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"s"},size:["wide"]},ht=class extends C{getGlobalCSS(){return ra}get aemFragmentMapping(){return qn}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
                    ${this.badge}
...
`;var Zn={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},dt=class extends C{getGlobalCSS(){return na}get aemFragmentMapping(){return Zn}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`,Ue.MISSING_INTL_API,a);var k=r.getPluralRules(t,{type:h.pluralType}).select(u-(h.offset||0));S=h.options[k]||h.options.other}if(!S)throw new Ci(h.value,u,Object.keys(h.options),a);s.push.apply(s,Wt(S.value,t,r,n,i,u-(h.offset||0)));continue}}return pl(s)}function gl(e,t){return t?A(A(A({},e||{}),t||{}),Object.keys(e).reduce(function(r,n){return r[n]=A(A({},e[n]),t[n]||{}),r},{})):e}function xl(e,t){return t?Object.keys(e).reduce(function(r,n){return r[n]=gl(e[n],t[n]),r},A({},e)):e}function Ii(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function bl(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Yt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.NumberFormat).bind.apply(t,kr([void 0],r,!1)))},{cache:Ii(e.number),strategy:Ur.variadic}),getDateTimeFormat:Yt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.DateTimeFormat).bind.apply(t,kr([void 0],r,!1)))},{cache:Ii(e.dateTime),strategy:Ur.variadic}),getPluralRules:Yt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.PluralRules).bind.apply(t,kr([void 0],r,!1)))},{cache:Ii(e.pluralRules),strategy:Ur.variadic})}}var za=function(){function e(t,r,n,i){var o=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(a){var s=o.formatToParts(a);if(s.length===1)return s[0].value;var c=s.reduce(function(l,h){return!l.length||h.type!==z.literal||typeof l[l.length-1]!="string"?l.push(h.value):l[l.length-1]+=h.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(a){return Wt(o.ast,o.locales,o.formatters,o.formats,a,void 0,o.message)},this.resolvedOptions=function(){return{locale:o.resolvedLocale.toString()}},this.getAst=function(){return o.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=xl(e.formats,n),this.formatters=i&&i.formatters||bl(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=Ha,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var Fa=za;var vl=/[0-9\-+#]/,Al=/[^\d\-+#]/g;function Ka(e){return e.search(vl)}function El(e="#.##"){let t={},r=e.length,n=Ka(e);t.prefix=n>0?e.substring(0,n):"";let i=Ka(e.split("").reverse().join("")),o=r-i,a=e.substring(o,o+1),s=o+(a==="."||a===","?1:0);t.suffix=i>0?e.substring(s,r):"",t.mask=e.substring(n,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let c=t.mask.match(Al);return t.decimal=c&&c[c.length-1]||".",t.separator=c&&c[1]&&c[0]||",",c=t.mask.split(t.decimal),t.integer=c[0],t.fraction=c[1],t}function Sl(e,t,r){let n=!1,i={value:e};e<0&&(n=!0,i.value=-i.value),i.sign=n?"-":"",i.value=Number(i.value).toFixed(t.fraction&&t.fraction.length),i.value=Number(i.value).toString();let o=t.fraction&&t.fraction.lastIndexOf("0"),[a="0",s=""]=i.value.split(".");return(!s||s&&s.length<=o)&&(s=o<0?"":(+("0."+s)).toFixed(o+1).replace("0.","")),i.integer=a,i.fraction=s,yl(i,t),(i.result==="0"||i.result==="")&&(n=!1,i.sign=""),!n&&t.maskHasPositiveSign?i.sign="+":n&&t.maskHasPositiveSign?i.sign="-":n&&(i.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),i}function yl(e,t){e.result="";let r=t.integer.split(t.separator),n=r.join(""),i=n&&n.indexOf("0");if(i>-1)for(;e.integer.length<n.length-i;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let o=r[1]&&r[r.length-1].length;if(o){let a=e.integer.length,s=a%o;for(let c=0;c<a;c++)e.result+=e.integer.charAt(c),!((c-s+1)%o)&&c<a-o&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function Tl(e,t,r={}){if(!e||isNaN(Number(t)))return t;let n=El(e),i=Sl(t,n,r);return n.prefix+i.sign+i.result+n.suffix}var ja=Tl;var Ya=".",Ll=",",Wa=/^\s+/,qa=/\s+$/,Xa="&nbsp;",ki=e=>e*12,Za=(e,t)=>{let{start:r,end:n,displaySummary:{amount:i,duration:o,minProductQuantity:a,outcomeType:s}={}}=e;if(!(i&&o&&s&&a))return!1;let c=t?new Date(t):new Date;if(!r||!n)return!1;let l=new Date(r),h=new Date(n);return c>=l&&c<=h},De={MONTH:"MONTH",YEAR:"YEAR"},_l={[N.ANNUAL]:12,[N.MONTHLY]:1,[N.THREE_YEARS]:36,[N.TWO_YEARS]:24},Ni=(e,t)=>({accept:e,round:t}),wl=[Ni(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),Ni(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.round(t/e*100)/100),Ni(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],Oi={[H.YEAR]:{[N.MONTHLY]:De.MONTH,[N.ANNUAL]:De.YEAR},[H.MONTH]:{[N.MONTHLY]:De.MONTH}},Pl=(e,t)=>e.indexOf(`'${t}'`)===0,Cl=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),n=Qa(r);return!!n?t||(r=r.replace(/[,\.]0+/,n)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+kl(e)),r},Il=e=>{let t=Nl(e),r=Pl(e,t),n=e.replace(/'.*?'/,""),i=Wa.test(n)||qa.test(n);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:i}},Ja=e=>e.replace(Wa,Xa).replace(qa,Xa),kl=e=>e.match(/#(.?)#/)?.[1]===Ya?Ll:Ya,Nl=e=>e.match(/'(.*?)'/)?.[1]??"",Qa=e=>e.match(/0(.?)0/)?.[1]??"";function bt({formatString:e,price:t,usePrecision:r,isIndianPrice:n=!1},i,o=a=>a){let{currencySymbol:a,isCurrencyFirst:s,hasCurrencySpace:c}=Il(e),l=r?Qa(e):"",h=Cl(e,r),d=r?2:0,u=o(t,{currencySymbol:a}),m=n?u.toLocaleString("hi-IN",{minimumFractionDigits:d,maximumFractionDigits:d}):ja(h,u),g=r?m.lastIndexOf(l):m.length,f=m.substring(0,g),T=m.substring(g+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,m).replace(/SYMBOL/,a),currencySymbol:a,decimals:T,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:i}}var es=e=>{let{commitment:t,term:r,usePrecision:n}=e,i=_l[r]??1;return bt(e,i>1?De.MONTH:Oi[t]?.[r],o=>{let a={divisor:i,price:o,usePrecision:n},{round:s}=wl.find(({accept:c})=>c(a));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(a)}`);return s(a)})},ts=({commitment:e,term:t,...r})=>bt(r,Oi[e]?.[t]),rs=e=>{let{commitment:t,instant:r,price:n,originalPrice:i,priceWithoutDiscount:o,promotion:a,quantity:s=1,term:c}=e;if(t===H.YEAR&&c===N.MONTHLY){if(!a)return bt(e,De.YEAR,ki);let{displaySummary:{outcomeType:l,duration:h,minProductQuantity:d=1}={}}=a;switch(l){case"PERCENTAGE_DISCOUNT":if(s>=d&&Za(a,r)){let u=parseInt(h.replace("P","").replace("M",""));if(isNaN(u))return ki(n);let m=s*i*u,g=s*o*(12-u),f=Math.floor((m+g)*100)/100;return bt({...e,price:f},De.YEAR)}default:return bt(e,De.YEAR,()=>ki(o??n))}}return bt(e,Oi[t]?.[c])};var Ol={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at {alternativePrice}",strikethroughAriaLabel:"Regularly at {strikethroughPrice}"},Rl=pa("ConsonantTemplates/price"),Ml=/<\/?[^>]+(>|$)/g,G={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Be={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel"},Vl="TAX_EXCLUSIVE",$l=e=>ma(e)?Object.entries(e).filter(([,t])=>mt(t)||Pr(t)||t===!0).reduce((t,[r,n])=>t+` ${r}${n===!0?"":'="'+da(n)+'"'}`,""):"",K=(e,t,r,n=!1)=>`<span class="${e}${t?"":" "+G.disabled}"${$l(r)}>${n?Ja(t):t??""}</span>`;function Hl(e,{accessibleLabel:t,currencySymbol:r,decimals:n,decimalsDelimiter:i,hasCurrencySpace:o,integer:a,isCurrencyFirst:s,recurrenceLabel:c,perUnitLabel:l,taxInclusivityLabel:h},d={}){let u=K(G.currencySymbol,r),m=K(G.currencySpace,o?"&nbsp;":""),g="";return s&&(g+=u+m),g+=K(G.integer,a),g+=K(G.decimalsDelimiter,i),g+=K(G.decimals,n),s||(g+=m+u),g+=K(G.recurrence,c,null,!0),g+=K(G.unitType,l,null,!0),g+=K(G.taxInclusivity,h,!0),K(e,g,{...d,"aria-label":t})}var W=({displayOptical:e=!1,displayStrikethrough:t=!1,displayAnnual:r=!1,instant:n=void 0}={})=>({country:i,displayFormatted:o=!0,displayRecurrence:a=!0,displayPerUnit:s=!1,displayTax:c=!1,language:l,literals:h={},quantity:d=1}={},{commitment:u,offerSelectorIds:m,formatString:g,price:f,priceWithoutDiscount:T,taxDisplay:_,taxTerm:b,term:S,usePrecision:k,promotion:R}={},U={})=>{Object.entries({country:i,formatString:g,language:l,price:f}).forEach(([ae,Zr])=>{if(Zr==null)throw new Error(`Argument "${ae}" is missing for osi ${m?.toString()}, country ${i}, language ${l}`)});let $={...Ol,...h},me=`${l.toLowerCase()}-${i.toUpperCase()}`;function Z(ae,Zr){let Jr=$[ae];if(Jr==null)return"";try{return new Fa(Jr.replace(Ml,""),me).format(Zr)}catch{return Rl.error("Failed to format literal:",Jr),""}}let Tt=t&&T?T:f,Ye=e?es:ts;r&&(Ye=rs);let{accessiblePrice:Lt,recurrenceTerm:pe,...fe}=Ye({commitment:u,formatString:g,instant:n,isIndianPrice:i==="IN",originalPrice:f,priceWithoutDiscount:T,price:e?f:Tt,promotion:R,quantity:d,term:S,usePrecision:k}),J=Lt,_t="";if(y(a)&&pe){let ae=Z(Be.recurrenceAriaLabel,{recurrenceTerm:pe});ae&&(J+=" "+ae),_t=Z(Be.recurrenceLabel,{recurrenceTerm:pe})}let qr="";if(y(s)){qr=Z(Be.perUnitLabel,{perUnit:"LICENSE"});let ae=Z(Be.perUnitAriaLabel,{perUnit:"LICENSE"});ae&&(J+=" "+ae)}let wt="";y(c)&&b&&(wt=Z(_===Vl?Be.taxExclusiveLabel:Be.taxInclusiveLabel,{taxTerm:b}),wt&&(J+=" "+wt)),t&&(J=Z(Be.strikethroughAriaLabel,{strikethroughPrice:J}));let Pt=G.container;if(e&&(Pt+=" "+G.containerOptical),t&&(Pt+=" "+G.containerStrikethrough),r&&(Pt+=" "+G.containerAnnual),y(o))return Hl(Pt,{...fe,accessibleLabel:J,recurrenceLabel:_t,perUnitLabel:qr,taxInclusivityLabel:wt},U);let{currencySymbol:no,decimals:Os,decimalsDelimiter:Rs,hasCurrencySpace:io,integer:Ms,isCurrencyFirst:Vs}=fe,Xe=[Ms,Rs,Os];Vs?(Xe.unshift(io?"\xA0":""),Xe.unshift(no)):(Xe.push(io?"\xA0":""),Xe.push(no)),Xe.push(_t,qr,wt);let $s=Xe.join("");return K(Pt,$s,U)},ns=()=>(e,t,r)=>{let i=(e.displayOldPrice===void 0||y(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${W()(e,t,r)}${i?"&nbsp;"+W({displayStrikethrough:!0})(e,t,r):""}`},is=()=>(e,t,r)=>{let{instant:n}=e;try{n||(n=new URLSearchParams(document.location.search).get("instant")),n&&(n=new Date(n))}catch{n=void 0}let i={...e,displayTax:!1,displayPerUnit:!1};return`${(e.displayOldPrice===void 0||y(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price?W({displayStrikethrough:!0})(i,t,r)+"&nbsp;":""}${W()(e,t,r)}${K(G.containerAnnualPrefix,"&nbsp;(")}${W({displayAnnual:!0,instant:n})(i,t,r)}${K(G.containerAnnualSuffix,")")}`},os=()=>(e,t,r)=>{let n={...e,displayTax:!1,displayPerUnit:!1};return`${W()(e,t,r)}${K(G.containerAnnualPrefix,"&nbsp;(")}${W({displayAnnual:!0})(n,t,r)}${K(G.containerAnnualSuffix,")")}`};var Ri=W(),Mi=ns(),Vi=W({displayOptical:!0}),$i=W({displayStrikethrough:!0}),Hi=W({displayAnnual:!0}),Ui=os(),Di=is();var Ul=(e,t)=>{if(!(!ft(e)||!ft(t)))return Math.floor((t-e)/t*100)},as=()=>(e,t)=>{let{price:r,priceWithoutDiscount:n}=t,i=Ul(r,n);return i===void 0?'<span class="no-discount"></span>':`<span class="discount">${i}%</span>`};var Bi=as();var{freeze:qt}=Object,re=qt({...$e}),ne=qt({...Q}),Ge={STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"},Gi=qt({...H}),zi=qt({...ga}),Fi=qt({...N});var ss="mas-commerce-service";function cs(e,{once:t=!1}={}){let r=null;function n(){let i=document.querySelector(ss);i!==r&&(r=i,i&&e(i))}return document.addEventListener(rt,n,{once:t}),ze(n),()=>document.removeEventListener(rt,n)}function Zt(e,{country:t,forceTaxExclusive:r,perpetual:n}){let i;if(e.length<2)i=e;else{let o=t==="GB"||n?"EN":"MULT",[a,s]=e;i=[a.language===o?a:s]}return r&&(i=i.map(gi)),i}var ze=e=>window.setTimeout(e);function vt(e,t=1){if(e==null)return[t];let r=(Array.isArray(e)?e:String(e).split(",")).map(xt).filter(ft);return r.length||(r=[t]),r}function Dr(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(li)}function q(){return document.getElementsByTagName(ss)?.[0]}var Fe={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},ls=1e3,hs=new Set;function Dl(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function ds(e){if(e==null)return;let t=typeof e;if(t==="function")return e.name?`function ${e.name}`:"function";if(t==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:n,originatingRequest:i,status:o}=e;return[n,o,i].filter(Boolean).join(" ")}let r=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Fe.serializableTypes.includes(r))return r}return e}function Bl(e,t){if(!Fe.ignoredProperties.includes(e))return ds(t)}var Ki={append(e){if(e.level!=="error")return;let{message:t,params:r}=e,n=[],i=[],o=t;r.forEach(l=>{l!=null&&(Dl(l)?n:i).push(l)}),n.length&&(o+=" "+n.map(ds).join(" "));let{pathname:a,search:s}=window.location,c=`${Fe.delimiter}page=${a}${s}`;c.length>ls&&(c=`${c.slice(0,ls)}<trunc>`),o+=c,i.length&&(o+=`${Fe.delimiter}facts=`,o+=JSON.stringify(i,Bl)),hs.has(o)||(hs.add(o),window.lana?.log(o,Fe))}};function At(e){Object.assign(Fe,Object.fromEntries(Object.entries(e).filter(([t,r])=>t in Fe&&r!==""&&r!==null&&r!==void 0&&!Number.isNaN(r))))}var L=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflow:re.V3,checkoutWorkflowStep:ne.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,env:Ge.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsBufferDelay:1,wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:Me.PUBLISHED,wcsBufferLimit:1});var ji=Object.freeze({LOCAL:"local",PROD:"prod",STAGE:"stage"});function Gl({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||L.language),t??(t=e?.split("_")?.[1]||L.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function Yi(e={}){let{commerce:t={}}=e,r=Ge.PRODUCTION,n=Fn,i=O("checkoutClientId",t)??L.checkoutClientId,o=Se(O("checkoutWorkflow",t),re,L.checkoutWorkflow),a=ne.CHECKOUT;o===re.V3&&(a=Se(O("checkoutWorkflowStep",t),ne,L.checkoutWorkflowStep));let s=y(O("displayOldPrice",t),L.displayOldPrice),c=y(O("displayPerUnit",t),L.displayPerUnit),l=y(O("displayRecurrence",t),L.displayRecurrence),h=y(O("displayTax",t),L.displayTax),d=y(O("entitlement",t),L.entitlement),u=y(O("modal",t),L.modal),m=y(O("forceTaxExclusive",t),L.forceTaxExclusive),g=O("promotionCode",t)??L.promotionCode,f=vt(O("quantity",t)),T=O("wcsApiKey",t)??L.wcsApiKey,_=t?.env==="stage",b=Me.PUBLISHED;["true",""].includes(t.allowOverride)&&(_=(O(Gn,t,{metadata:!1})?.toLowerCase()??t?.env)==="stage",b=Se(O(zn,t),Me,b)),_&&(r=Ge.STAGE,n=Kn);let k=xt(O("wcsBufferDelay",t),L.wcsBufferDelay),R=xt(O("wcsBufferLimit",t),L.wcsBufferLimit);return{...Gl(e),displayOldPrice:s,checkoutClientId:i,checkoutWorkflow:o,checkoutWorkflowStep:a,displayPerUnit:c,displayRecurrence:l,displayTax:h,entitlement:d,extraOptions:L.extraOptions,modal:u,env:r,forceTaxExclusive:m,promotionCode:g,quantity:f,wcsApiKey:T,wcsBufferDelay:k,wcsBufferLimit:R,wcsURL:n,landscape:b}}var Xi={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},zl=Date.now(),Wi=new Set,qi=new Set,us=new Map,ms={append({level:e,message:t,params:r,timestamp:n,source:i}){console[e](`${n}ms [${i}] %c${t}`,"font-weight: bold;",...r)}},ps={filter:({level:e})=>e!==Xi.DEBUG},Fl={filter:()=>!1};function Kl(e,t,r,n,i){return{level:e,message:t,namespace:r,get params(){return n.length===1&&Gt(n[0])&&(n=n[0](),Array.isArray(n)||(n=[n])),n},source:i,timestamp:Date.now()-zl}}function jl(e){[...qi].every(t=>t(e))&&Wi.forEach(t=>t(e))}function fs(e){let t=(us.get(e)??0)+1;us.set(e,t);let r=`${e} #${t}`,n={id:r,namespace:e,module:i=>fs(`${n.namespace}/${i}`),updateConfig:At};return Object.values(Xi).forEach(i=>{n[i]=(o,...a)=>jl(Kl(i,o,e,a,r))}),Object.seal(n)}function Br(...e){e.forEach(t=>{let{append:r,filter:n}=t;Gt(n)&&qi.add(n),Gt(r)&&Wi.add(r)})}function Yl(e={}){let{name:t}=e,r=y(O("commerce.debug",{search:!0,storage:!0}),t===ji.LOCAL);return Br(r?ms:ps),t===ji.PROD&&Br(Ki),Y}function Xl(){Wi.clear(),qi.clear()}var Y={...fs(Bn),Level:Xi,Plugins:{consoleAppender:ms,debugFilter:ps,quietFilter:Fl,lanaAppender:Ki},init:Yl,reset:Xl,use:Br};var Wl={[ce]:Mn,[Ee]:Vn,[le]:$n},ql={[ce]:Un,[le]:Dn},Et=class{constructor(t){p(this,"changes",new Map);p(this,"connected",!1);p(this,"dispose",pt);p(this,"error");p(this,"log");p(this,"options");p(this,"promises",[]);p(this,"state",Ee);p(this,"timer",null);p(this,"value");p(this,"version",0);p(this,"wrapperElement");this.wrapperElement=t}update(){[ce,Ee,le].forEach(t=>{this.wrapperElement.classList.toggle(Wl[t],t===this.state)})}notify(){(this.state===le||this.state===ce)&&(this.state===le?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===ce&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]),this.wrapperElement.dispatchEvent(new CustomEvent(ql[this.state],{bubbles:!0}))}attributeChangedCallback(t,r,n){this.changes.set(t,n),this.requestUpdate()}connectedCallback(){this.dispose=cs(()=>this.requestUpdate(!0))}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement})),this.dispose(),this.dispose=pt}onceSettled(){let{error:t,promises:r,state:n}=this;return le===n?Promise.resolve(this.wrapperElement):ce===n?Promise.reject(t):new Promise((i,o)=>{r.push({resolve:i,reject:o})})}toggleResolved(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.state=le,this.value=r,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:r}),ze(()=>this.notify()),!0)}toggleFailed(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.error=r,this.state=ce,this.update(),this.log?.error("Failed:",{element:this.wrapperElement,error:r}),ze(()=>this.notify()),!0)}togglePending(t){return this.version++,t&&(this.options=t),this.state=Ee,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!q()||this.timer)return;let r=Y.module("mas-element"),{error:n,options:i,state:o,value:a,version:s}=this;this.state=Ee,this.timer=ze(async()=>{this.timer=null;let c=null;if(this.changes.size&&(c=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:c}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:c})),c||t)try{await this.wrapperElement.render?.()===!1&&this.state===Ee&&this.version===s&&(this.state=o,this.error=n,this.value=a,this.update(),this.notify())}catch(l){r.error("Failed to render mas-element: ",l),this.toggleFailed(this.version,l,i)}})}};function gs(e={}){return Object.entries(e).forEach(([t,r])=>{(r==null||r===""||r?.length===0)&&delete e[t]}),e}function Gr(e,t={}){let{tag:r,is:n}=e,i=document.createElement(r,{is:n});return i.setAttribute("is",n),Object.assign(i.dataset,gs(t)),i}function zr(e,t={}){return e instanceof HTMLElement?(Object.assign(e.dataset,gs(t)),e):null}var Zl="download",Jl="upgrade";function Fr(e,t={},r=""){let n=q();if(!n)return null;let{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:l,perpetual:h,promotionCode:d,quantity:u,wcsOsi:m,extraOptions:g}=n.collectCheckoutOptions(t),f=Gr(e,{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:l,perpetual:h,promotionCode:d,quantity:u,wcsOsi:m,extraOptions:g});return r&&(f.innerHTML=`<span style="pointer-events: none;">${r}</span>`),f}function Kr(e){return class extends e{constructor(){super(...arguments);p(this,"checkoutActionHandler");p(this,"masElement",new Et(this))}attributeChangedCallback(n,i,o){this.masElement.attributeChangedCallback(n,i,o)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(n=!1){return this.masElement.requestUpdate(n)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(n={}){if(!this.isConnected)return!1;let i=q();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(d=>{d&&(this.dataset.imsCountry=d)},pt),n.imsCountry=null;let o=i.collectCheckoutOptions(n,this);if(!o.wcsOsi.length)return!1;let a;try{a=JSON.parse(o.extraOptions??"{}")}catch(d){this.masElement.log?.error("cannot parse exta checkout options",d)}let s=this.masElement.togglePending(o);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(o),l=await Promise.all(c);l=l.map(d=>Zt(d,o)),o.country=this.dataset.imsCountry||o.country;let h=await i.buildCheckoutAction?.(l.flat(),{...a,...o},this);return this.renderOffers(l.flat(),o,{},h,s)}renderOffers(n,i,o={},a=void 0,s=void 0){if(!this.isConnected)return!1;let c=q();if(!c)return!1;if(i={...JSON.parse(this.dataset.extraOptions??"null"),...i,...o},s??(s=this.masElement.togglePending(i)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),a){this.classList.remove(Zl,Jl),this.masElement.toggleResolved(s,n,i);let{url:h,text:d,className:u,handler:m}=a;return h&&this.setCheckoutUrl(h),d&&(this.firstElementChild.innerHTML=d),u&&this.classList.add(...u.split(" ")),m&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=m.bind(this)),!0}else if(n.length){if(this.masElement.toggleResolved(s,n,i)){let h=c.buildCheckoutURL(n,i);return this.setCheckoutUrl(h),!0}}else{let h=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,h,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(n){}updateOptions(n={}){let i=q();if(!i)return!1;let{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:h,perpetual:d,promotionCode:u,quantity:m,wcsOsi:g}=i.collectCheckoutOptions(n);return zr(this,{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:h,perpetual:d,promotionCode:u,quantity:m,wcsOsi:g}),!0}}}var Jt=class Jt extends Kr(HTMLButtonElement){static createCheckoutButton(t={},r=""){return Fr(Jt,t,r)}setCheckoutUrl(t){this.setAttribute("data-href",t)}get href(){return this.getAttribute("data-href")}get isCheckoutButton(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}this.href&&(window.location.href=this.href)}};p(Jt,"is","checkout-button"),p(Jt,"tag","button");var Ke=Jt;window.customElements.get(Ke.is)||window.customElements.define(Ke.is,Ke,{extends:Ke.tag});var Ql="#000000",eh="#F8D904",th=/(accent|primary|secondary)(-(outline|link))?/,rh="mas:product_code/",nh="daa-ll",jr="daa-lh",ih=["XL","L","M","S"];function oh(e,t,r){e.mnemonicIcon?.map((i,o)=>({icon:i,alt:e.mnemonicAlt[o]??"",link:e.mnemonicLink[o]??""}))?.forEach(({icon:i,alt:o,link:a})=>{if(a&&!/^https?:/.test(a))try{a=new URL(`https://${a}`).href.toString()}catch{a="#"}let s={slot:"icons",src:i,loading:t.loading,size:r?.size??"l"};o&&(s.alt=o),a&&(s.href=a);let c=te("merch-icon",s);t.append(c)})}function ah(e,t,r){e.badge&&(t.setAttribute("badge-text",e.badge),t.setAttribute("badge-color",e.badgeColor||r?.color||Ql),t.setAttribute("badge-background-color",e.badgeBackgroundColor||r?.backgroundColor||eh))}function sh(e,t,r){r?.includes(e.size)&&t.setAttribute("size",e.size)}function ch(e,t,r){e.cardTitle&&r&&t.append(te(r.tag,{slot:r.slot},e.cardTitle))}function lh(e,t,r){e.subtitle&&r&&t.append(te(r.tag,{slot:r.slot},e.subtitle))}function hh(e,t,r){if(e.backgroundImage){let n={loading:t.loading??"lazy",src:e.backgroundImage};if(e.backgroundImageAltText?n.alt=e.backgroundImageAltText:n.role="none",!r)return;if(r?.attribute){t.setAttribute(r.attribute,e.backgroundImage);return}t.append(te(r.tag,{slot:r.slot},te("img",n)))}}function dh(e,t,r){if(e.prices&&r){let n=te(r.tag,{slot:r.slot},e.prices);t.append(n)}}function uh(e,t,r){if(e.description&&r){let n=te(r.tag,{slot:r.slot},e.description);t.append(n)}}function mh(e,t,r,n){let o=customElements.get("checkout-button").createCheckoutButton({},e.innerHTML);o.setAttribute("tabindex",0);for(let h of e.attributes)["class","is"].includes(h.name)||o.setAttribute(h.name,h.value);o.firstElementChild?.classList.add("spectrum-Button-label");let a=t.ctas.size??"M",s=`spectrum-Button--${n}`,c=ih.includes(a)?`spectrum-Button--size${a}`:"spectrum-Button--sizeM",l=["spectrum-Button",s,c];return r&&l.push("spectrum-Button--outline"),o.classList.add(...l),o}function ph(e,t,r,n){let i="fill";r&&(i="outline");let o=te("sp-button",{treatment:i,variant:n,tabIndex:0,size:t.ctas.size??"m"},e);return o.addEventListener("click",a=>{a.target!==e&&(a.stopPropagation(),e.click())}),o}function fh(e,t){return e.classList.add("con-button"),t&&e.classList.add("blue"),e}function gh(e,t,r,n){if(e.ctas){let{slot:i}=r.ctas,o=te("div",{slot:i},e.ctas),a=[...o.querySelectorAll("a")].map(s=>{let c=s.parentElement.tagName==="STRONG";if(t.consonant)return fh(s,c);let l=th.exec(s.className)?.[0]??"accent",h=l.includes("accent"),d=l.includes("primary"),u=l.includes("secondary"),m=l.includes("-outline");if(l.includes("-link"))return s;let f;return h||c?f="accent":d?f="primary":u&&(f="secondary"),t.spectrum==="swc"?ph(s,r,m,f):mh(s,r,m,f)});o.innerHTML="",o.append(...a),t.append(o)}}function xh(e,t){let{tags:r}=e,n=r?.find(i=>i.startsWith(rh))?.split("/").pop();n&&(t.setAttribute(jr,n),t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]").forEach((i,o)=>{i.setAttribute(nh,`${i.dataset.analyticsId}-${o+1}`)}))}function bh(e){e.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,r])=>{e.querySelectorAll(`a.${t}`).forEach(n=>{n.classList.remove(t),n.classList.add("spectrum-Link",`spectrum-Link--${r}`)})})}async function xs(e,t){let{fields:r}=e,{variant:n}=r;if(!n)return;t.querySelectorAll("[slot]").forEach(o=>{o.remove()}),t.removeAttribute("background-image"),t.removeAttribute("badge-background-color"),t.removeAttribute("badge-color"),t.removeAttribute("badge-text"),t.removeAttribute("size"),t.classList.remove("wide-strip"),t.classList.remove("thin-strip"),t.removeAttribute(jr),t.variant=n,await t.updateComplete;let{aemFragmentMapping:i}=t.variantLayout;i&&(oh(r,t,i.mnemonics),ah(r,t,i.badge),sh(r,t,i.size),ch(r,t,i.title),lh(r,t,i.subtitle),dh(r,t,i.prices),hh(r,t,i.backgroundImage),uh(r,t,i.description),gh(r,t,i,n),xh(r,t),bh(t))}var vh="merch-card",Ah=":start",Eh=":ready",Sh=1e4,bs="merch-card:",er,Zi,Qt=class extends ee{constructor(){super();F(this,er);p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this)}static getFragmentMapping(r){return ia[r]}firstUpdated(){this.variantLayout=Jn(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(()=>{this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=Jn(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(r)}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["twp","ccd-slice","ccd-suggested"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback();let r=this.querySelector("aem-fragment")?.getAttribute("fragment");performance.mark(`${bs}${r}${Ah}`),this.addEventListener(Er,this.handleQuantitySelection),this.addEventListener(In,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener(Re,this.handleAemFragmentEvents),this.addEventListener(Oe,this.handleAemFragmentEvents),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(Er,this.handleQuantitySelection),this.storageOptions?.removeEventListener(Ar,this.handleStorageChange),this.removeEventListener(Re,this.handleAemFragmentEvents),this.removeEventListener(Oe,this.handleAemFragmentEvents)}async handleAemFragmentEvents(r){if(r.type===Re&&ge(this,er,Zi).call(this,"AEM fragment cannot be loaded"),r.type===Oe&&r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;await xs(n,this),this.checkReady()}}async checkReady(){let r=Promise.all([...this.querySelectorAll('span[is="inline-price"][data-wcs-osi],a[is="checkout-link"][data-wcs-osi]')].map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(a=>a.classList.contains("placeholder-resolved"))),n=new Promise(o=>setTimeout(()=>o(!1),Sh));if(await Promise.race([r,n])===!0){performance.mark(`${bs}${this.id}${Eh}`),this.dispatchEvent(new CustomEvent(On,{bubbles:!0,composed:!0}));return}ge(this,er,Zi).call(this,"Contains unresolved offers")}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let r=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll('a[is="checkout-link"].con-button')).length===2&&r&&r.parentElement.classList.add("footer-column")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||(this.dispatchEvent(new CustomEvent(kn,{bubbles:!0})),this.displayFooterElementsInColumn())}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(Ar,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};er=new WeakSet,Zi=function(r){this.dispatchEvent(new CustomEvent(Rn,{detail:r,bubbles:!0,composed:!0}))},p(Qt,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:jr,reflect:!0},loading:{type:String}}),p(Qt,"styles",[zo,oa(),...Fo()]);customElements.define(vh,Qt);var St=class extends ee{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?x`<a href="${t}">
    ...
    `);customElements.define("merch-icon",St);var Ss=new CSSStyleSheet;Ss.replaceSync(":host { display: contents; }");var yh=document.querySelector('meta[name="aem-base-url"]')?.content??"https://odin.adobe.com",vs="fragment",As="author",Th="ims",Es=e=>{throw new Error(`Failed to get fragment: ${e}`)};async function Lh(e,t,r,n){let i=r?`${e}/adobe/sites/cf/fragments/${t}`:`${e}/adobe/sites/fragments/${t}`,o=await fetch(i,{cache:"default",credentials:"omit",headers:n}).catch(a=>Es(a.message));return o?.ok||Es(`${o.status} ${o.statusText}`),o.json()}var Ji,ye,Qi=class{constructor(){F(this,ye,new Map)}clear(){w(this,ye).clear()}add(...t){t.forEach(r=>{let{id:n}=r;n&&w(this,ye).set(n,r)})}has(t){return w(this,ye).has(t)}get(t){return w(this,ye).get(t)}remove(t){w(this,ye).delete(t)}};ye=new WeakMap;var Yr=new Qi,je,he,Te,tr,de,yt,ue,to,ys,Ts,eo=class extends HTMLElement{constructor(){super();F(this,ue);p(this,"cache",Yr);F(this,je);F(this,he);F(this,Te);F(this,tr,!1);F(this,de);F(this,yt,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Ss];let r=this.getAttribute(Th);["",!0,"true"].includes(r)&&(j(this,tr,!0),Ji||(Ji={Authorization:`Bearer ${window.adobeid?.authorize?.()}`}))}static get observedAttributes(){return[vs,As]}attributeChangedCallback(r,n,i){r===vs&&(j(this,Te,i),this.refresh(!1)),r===As&&j(this,yt,["","true"].includes(i))}connectedCallback(){if(!w(this,Te)){ge(this,ue,to).call(this,"Missing fragment id");return}}async refresh(r=!0){w(this,de)&&!await Promise.race([w(this,de),Promise.resolve(!1)])||(r&&Yr.remove(w(this,Te)),j(this,de,this.fetchData().then(()=>(this.dispatchEvent(new CustomEvent(Oe,{detail:this.data,bubbles:!0,composed:!0})),!0)).catch(n=>(ge(this,ue,to).call(this,"Network error: failed to load fragment"),j(this,de,null),!1))),w(this,de))}async fetchData(){j(this,je,null),j(this,he,null);let r=Yr.get(w(this,Te));r||(r=await Lh(yh,w(this,Te),w(this,yt),w(this,tr)?Ji:void 0),Yr.add(r)),j(this,je,r)}get updateComplete(){return w(this,de)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return w(this,he)?w(this,he):(w(this,yt)?ge(this,ue,ys).call(this):ge(this,ue,Ts).call(this),w(this,he))}};je=new WeakMap,he=new WeakMap,Te=new WeakMap,tr=new WeakMap,de=new WeakMap,yt=new WeakMap,ue=new WeakSet,to=function(r){this.classList.add("error"),this.dispatchEvent(new CustomEvent(Re,{detail:r,bubbles:!0,composed:!0}))},ys=function(){let{fields:r,id:n,tags:i}=w(this,je);j(this,he,r.reduce((o,{name:a,multiple:s,values:c})=>(o.fields[a]=s?c:c[0],o),{fields:{},id:n,tags:i}))},Ts=function(){let{fields:r,id:n,tags:i}=w(this,je);j(this,he,Object.entries(r).reduce((o,[a,s])=>(o.fields[a]=s?.mimeType?s.value:s??"",o),{fields:{},id:n,tags:i}))};customElements.define("aem-fragment",eo);var rr=class rr extends Kr(HTMLAnchorElement){static createCheckoutLink(t={},r=""){return Fr(rr,t,r)}setCheckoutUrl(t){this.setAttribute("href",t)}get isCheckoutLink(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}}};p(rr,"is","checkout-link"),p(rr,"tag","a");var ie=rr;window.customElements.get(ie.is)||window.customElements.define(ie.is,ie,{extends:ie.tag});function Ls({providers:e,settings:t}){function r(o,a){let{checkoutClientId:s,checkoutWorkflow:c,checkoutWorkflowStep:l,country:h,language:d,promotionCode:u,quantity:m}=t,{checkoutMarketSegment:g,checkoutWorkflow:f=c,checkoutWorkflowStep:T=l,imsCountry:_,country:b=_??h,language:S=d,quantity:k=m,entitlement:R,upgrade:U,modal:$,perpetual:me,promotionCode:Z=u,wcsOsi:Tt,extraOptions:Ye,...Lt}=Object.assign({},a?.dataset??{},o??{}),pe=Se(f,re,L.checkoutWorkflow),fe=ne.CHECKOUT;pe===re.V3&&(fe=Se(T,ne,L.checkoutWorkflowStep));let J=gt({...Lt,extraOptions:Ye,checkoutClientId:s,checkoutMarketSegment:g,country:b,quantity:vt(k,L.quantity),checkoutWorkflow:pe,checkoutWorkflowStep:fe,language:S,entitlement:y(R),upgrade:y(U),modal:y($),perpetual:y(me),promotionCode:zt(Z).effectivePromoCode,wcsOsi:Dr(Tt)});if(a)for(let _t of e.checkout)_t(a,J);return J}function n(o,a){if(!Array.isArray(o)||!o.length||!a)return"";let{env:s,landscape:c}=t,{checkoutClientId:l,checkoutMarketSegment:h,checkoutWorkflow:d,checkoutWorkflowStep:u,country:m,promotionCode:g,quantity:f,...T}=r(a),_=window.frameElement?"if":"fp",b={checkoutPromoCode:g,clientId:l,context:_,country:m,env:s,items:[],marketSegment:h,workflowStep:u,landscape:c,...T};if(o.length===1){let[{offerId:S,offerType:k,productArrangementCode:R}]=o,{marketSegments:[U]}=o[0];Object.assign(b,{marketSegment:U,offerType:k,productArrangementCode:R}),b.items.push(f[0]===1?{id:S}:{id:S,quantity:f[0]})}else b.items.push(...o.map(({offerId:S},k)=>({id:S,quantity:f[k]??L.quantity})));return ni(d,b)}let{createCheckoutLink:i}=ie;return{CheckoutLink:ie,CheckoutWorkflow:re,CheckoutWorkflowStep:ne,buildCheckoutURL:n,collectCheckoutOptions:r,createCheckoutLink:i}}function _h({interval:e=200,maxAttempts:t=25}={}){let r=Y.module("ims");return new Promise(n=>{r.debug("Waing for IMS to be ready");let i=0;function o(){window.adobeIMS?.initialized?n():++i>t?(r.debug("Timeout"),n()):setTimeout(o,e)}o()})}function wh(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function Ph(e){let t=Y.module("ims");return e.then(r=>r?window.adobeIMS.getProfile().then(({countryCode:n})=>(t.debug("Got user country:",n),n),n=>{t.error("Unable to get user country:",n)}):null)}function _s({}){let e=_h(),t=wh(e),r=Ph(t);return{imsReadyPromise:e,imsSignedInPromise:t,imsCountryPromise:r}}async function Ps(e,t){let{data:r}=t||await Promise.resolve().then(()=>Ys(ws(),1));if(Array.isArray(r)){let n=o=>r.find(a=>wr(a.lang,o)),i=n(e.language)??n(L.language);if(i)return Object.freeze(i)}return{}}var Cs=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],Ih={INDIVIDUAL_COM:["ZA_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","ZA_en","SG_en","KR_ko"],TEAM_COM:["ZA_en","LT_lt","LV_lv","NG_en","ZA_en","CO_es","KR_ko"],INDIVIDUAL_EDU:["LT_lt","LV_lv","SA_en","SG_en"],TEAM_EDU:["SG_en","KR_ko"]},nr=class nr extends HTMLSpanElement{constructor(){super();p(this,"masElement",new Et(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-perpetual","data-promotion-code","data-tax-exclusive","data-template","data-wcs-osi"]}static createInlinePrice(r){let n=q();if(!n)return null;let{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,template:u,wcsOsi:m}=n.collectPriceOptions(r);return Gr(nr,{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,template:u,wcsOsi:m})}get isInlinePrice(){return!0}attributeChangedCallback(r,n,i){this.masElement.attributeChangedCallback(r,n,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}resolveDisplayTaxForGeoAndSegment(r,n,i,o){let a=`${r}_${n}`;if(Cs.includes(r)||Cs.includes(a))return!0;let s=Ih[`${i}_${o}`];return s?!!(s.includes(r)||s.includes(a)):!1}async resolveDisplayTax(r,n){let[i]=await r.resolveOfferSelectors(n),o=Zt(await i,n);if(o?.length){let{country:a,language:s}=n,c=o[0],[l=""]=c.marketSegments;return this.resolveDisplayTaxForGeoAndSegment(a,s,c.customerSegment,l)}}async render(r={}){if(!this.isConnected)return!1;let n=q();if(!n)return!1;let i=n.collectPriceOptions(r,this);if(!i.wcsOsi.length)return!1;let o=this.masElement.togglePending(i);this.innerHTML="";let[a]=n.resolveOfferSelectors(i);return this.renderOffers(Zt(await a,i),i,o)}renderOffers(r,n={},i=void 0){if(!this.isConnected)return;let o=q();if(!o)return!1;let a=o.collectPriceOptions({...this.dataset,...n},this);if(i??(i=this.masElement.togglePending(a)),r.length){if(this.masElement.toggleResolved(i,r,a))return this.innerHTML=o.buildPriceHTML(r,a),!0}else{let s=new Error(`Not provided: ${a?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,s,a))return this.innerHTML="",!0}return!1}updateOptions(r){let n=q();if(!n)return!1;let{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,template:u,wcsOsi:m}=n.collectPriceOptions(r);return zr(this,{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,template:u,wcsOsi:m}),!0}};p(nr,"is","inline-price"),p(nr,"tag","span");var oe=nr;window.customElements.get(oe.is)||window.customElements.define(oe.is,oe,{extends:oe.tag});function Is({literals:e,providers:t,settings:r}){function n(a,s){let{country:c,displayOldPrice:l,displayPerUnit:h,displayRecurrence:d,displayTax:u,forceTaxExclusive:m,language:g,promotionCode:f,quantity:T}=r,{displayOldPrice:_=l,displayPerUnit:b=h,displayRecurrence:S=d,displayTax:k=u,forceTaxExclusive:R=m,country:U=c,language:$=g,perpetual:me,promotionCode:Z=f,quantity:Tt=T,template:Ye,wcsOsi:Lt,...pe}=Object.assign({},s?.dataset??{},a??{}),fe=gt({...pe,country:U,displayOldPrice:y(_),displayPerUnit:y(b),displayRecurrence:y(S),displayTax:y(k),forceTaxExclusive:y(R),language:$,perpetual:y(me),promotionCode:zt(Z).effectivePromoCode,quantity:vt(Tt,L.quantity),template:Ye,wcsOsi:Dr(Lt)});if(s)for(let J of t.price)J(s,fe);return fe}function i(a,s){if(!Array.isArray(a)||!a.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=Bi;break;case"strikethrough":l=$i;break;case"optical":l=Vi;break;case"annual":l=Hi;break;default:s.country==="AU"&&a[0].planType==="ABM"?l=s.promotionCode?Di:Ui:l=s.promotionCode?Mi:Ri}let h=n(s);h.literals=Object.assign({},e.price,gt(s.literals??{}));let[d]=a;return d={...d,...d.priceDetails},l(h,d)}let o=oe.createInlinePrice;return{InlinePrice:oe,buildPriceHTML:i,collectPriceOptions:n,createInlinePrice:o}}function ks({settings:e}){let t=Y.module("wcs"),{env:r,wcsApiKey:n}=e,i=new Map,o=new Map,a;async function s(d,u,m=!0){let g=Hn;t.debug("Fetching:",d);let f="",T,_=(b,S,k)=>`${b}: ${S?.status}, url: ${k.toString()}`;try{if(d.offerSelectorIds=d.offerSelectorIds.sort(),f=new URL(e.wcsURL),f.searchParams.set("offer_selector_ids",d.offerSelectorIds.join(",")),f.searchParams.set("country",d.country),f.searchParams.set("locale",d.locale),f.searchParams.set("landscape",r===Ge.STAGE?"ALL":e.landscape),f.searchParams.set("api_key",n),d.language&&f.searchParams.set("language",d.language),d.promotionCode&&f.searchParams.set("promotion_code",d.promotionCode),d.currency&&f.searchParams.set("currency",d.currency),T=await fetch(f.toString(),{credentials:"omit"}),T.ok){let b=await T.json();t.debug("Fetched:",d,b);let S=b.resolvedOffers??[];S=S.map(Ir),u.forEach(({resolve:k},R)=>{let U=S.filter(({offerSelectorIds:$})=>$.includes(R)).flat();U.length&&(u.delete(R),k(U))})}else T.status===404&&d.offerSelectorIds.length>1?(t.debug("Multi-osi 404, fallback to fetch-by-one strategy"),await Promise.allSettled(d.offerSelectorIds.map(b=>s({...d,offerSelectorIds:[b]},u,!1)))):g=Sr}catch(b){g=Sr,t.error(g,d,b)}m&&u.size&&(t.debug("Missing:",{offerSelectorIds:[...u.keys()]}),u.forEach(b=>{b.reject(new Error(_(g,T,f)))}))}function c(){clearTimeout(a);let d=[...o.values()];o.clear(),d.forEach(({options:u,promises:m})=>s(u,m))}function l(){let d=i.size;i.clear(),t.debug(`Flushed ${d} cache entries`)}function h({country:d,language:u,perpetual:m=!1,promotionCode:g="",wcsOsi:f=[]}){let T=`${u}_${d}`;d!=="GB"&&(u=m?"EN":"MULT");let _=[d,u,g].filter(b=>b).join("-").toLowerCase();return f.map(b=>{let S=`${b}-${_}`;if(!i.has(S)){let k=new Promise((R,U)=>{let $=o.get(_);if(!$){let me={country:d,locale:T,offerSelectorIds:[]};d!=="GB"&&(me.language=u),$={options:me,promises:new Map},o.set(_,$)}g&&($.options.promotionCode=g),$.options.offerSelectorIds.push(b),$.promises.set(b,{resolve:R,reject:U}),$.options.offerSelectorIds.length>=e.wcsBufferLimit?c():(t.debug("Queued:",$.options),a||(a=setTimeout(c,e.wcsBufferDelay)))});i.set(S,k)}return i.get(S)})}return{WcsCommitment:Gi,WcsPlanType:zi,WcsTerm:Fi,resolveOfferSelectors:h,flushWcsCache:l}}var ro="mas-commerce-service",kh="mas:start",Nh="mas:ready",Wr,Ns,Xr=class extends HTMLElement{constructor(){super(...arguments);F(this,Wr);p(this,"promise",null)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(n,i,o)=>{let a=await r?.(n,i,this.imsSignedInPromise,o);return a||null})}async activate(){let r=w(this,Wr,Ns),n=Object.freeze(Yi(r));At(r.lana);let i=Y.init(r.hostEnv).module("service");i.debug("Activating:",r);let o={price:{}};try{o.price=await Ps(n,r.commerce.priceLiterals)}catch{}let a={checkout:new Set,price:new Set},s={literals:o,providers:a,settings:n};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Ls(s),..._s(s),...Is(s),...ks(s),...jn,Log:Y,get defaults(){return L},get log(){return Y},get providers(){return{checkout(c){return a.checkout.add(c),()=>a.checkout.delete(c)},price(c){return a.price.add(c),()=>a.price.delete(c)}}},get settings(){return n}})),i.debug("Activated:",{literals:o,settings:n}),ze(()=>{let c=new CustomEvent(rt,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Nh),this.dispatchEvent(c)})}connectedCallback(){this.readyPromise||(performance.mark(kh),this.readyPromise=this.activate())}disconnectedCallback(){this.readyPromise=null}flushWcsCache(){this.flushWcsCache(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCache(),document.querySelectorAll('span[is="inline-price"],a[is="checkout-link"]').forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers")}refreshFragments(){this.flushWcsCache(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh()),this.log.debug("Refreshed AEM fragments")}};Wr=new WeakSet,Ns=function(){let r={hostEnv:{name:this.getAttribute("host-env")??"prod"},commerce:{env:this.getAttribute("env")},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate"),10),isProdDomain:this.getAttribute("host-env")==="prod"}};return["locale","country","language"].forEach(n=>{let i=this.getAttribute(n);i&&(r[n]=i)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(n=>{let i=this.getAttribute(n);if(i!=null){let o=n.replace(/-([a-z])/g,a=>a[1].toUpperCase());r.commerce[o]=i}}),r},p(Xr,"instance");window.customElements.get(ro)||window.customElements.define(ro,Xr);At({sampleRate:1});export{Ke as CheckoutButton,ie as CheckoutLink,re as CheckoutWorkflow,ne as CheckoutWorkflowStep,L as Defaults,oe as InlinePrice,Me as Landscape,Y as Log,ro as TAG_NAME_SERVICE,Gi as WcsCommitment,zi as WcsPlanType,Fi as WcsTerm,Ir as applyPlanType,Yi as getSettings};
